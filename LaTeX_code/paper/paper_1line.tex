...
\hline
Model   &  parameters $(\theta_0, \alpha,\delta)$   & AIC & BIC \\ \hline
Model 1 &  $(\add,\add) $    &  \add   &  \add   \\ \hline
Model 2 &   $(1.2,0.1,0.6)$   &  \add   &   \add    \\ \hline
\end{tabular}
...
\hline
Forecast Provider & parameters $(\theta_0, \alpha,\delta)$ & AIC & BIC \\ \hline
...
\end{figure}
    ...
    \begin{figure}[h]
        \includegraphics[width=60mm,scale=1]{plots/paths_testing_days/1.eps}
  \includegraphics[width=60mm,scale=1]{plots/paths_testing_days/2.eps}\\
   \includegraphics[width=60mm,scale=1]{plots/paths_testing_days/3.eps}
  \includegraphics[width=60mm,scale=1]{plots/paths_testing_days/4.eps}
    ...
    \begin{figure}[h]
      \includegraphics[width=60mm,scale=1]{plots/bands_testing_days/1.eps}
  \includegraphics[width=60mm,scale=1]{plots/bands_testing_days/2.eps}\\
   \includegraphics[width=60mm,scale=1]{plots/bands_testing_days/3.eps}
  \includegraphics[width=60mm,scale=1]{plots/bands_testing_days/4.eps}
