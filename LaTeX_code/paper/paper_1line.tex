...
\begin{figure}
  ...
  \caption{Installed wind and solar power over the years. We recall the importance of accurate forecasts to use green energies optimally. {\color{red} We still have to ensure that the source is trusthable (Renzo will do it)}.}
