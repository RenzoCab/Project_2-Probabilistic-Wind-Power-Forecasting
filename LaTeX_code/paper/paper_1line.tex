...
Nevertheless, closed-form solutions to this initial-boundary value problem can be obtained only in a few cases. Besides, solving numerically (\ref{eq:fpk}) at every transition step is computationally expensive. 
