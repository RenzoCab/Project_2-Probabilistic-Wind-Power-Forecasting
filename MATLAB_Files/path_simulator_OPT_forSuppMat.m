...
for y = 1:2
    ...
    for w = 1:2
        ...
        %         xlabel('Time'), ylabel('Power');
                ...
                title([datestr(date_format),' and ',datestr(date_format_next)]);
                if save == 1
                    saveas(gcf,[pwd '/Results/supplementary_material/forecast_from_',set_type,'/bands/',num2str(i)],'epsc');
                end
                ...
                box;
                if save == 1
                    saveas(gcf,[pwd '/Results/supplementary_material/forecast_from_',set_type,'/paths/',num2str(i)],'epsc');
                end
...
copyfile('Results/supplementary_material', '../LaTeX_Code/Paper/Supplementary Material/plots');