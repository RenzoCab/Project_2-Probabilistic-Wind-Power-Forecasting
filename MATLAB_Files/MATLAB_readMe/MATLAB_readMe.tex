...
\alert{This function is independent of if we are using the real data or the truncated one.} If we take a total of $Z\in\N$ days, the batch corresponding to this days is
\begin{table}[]
