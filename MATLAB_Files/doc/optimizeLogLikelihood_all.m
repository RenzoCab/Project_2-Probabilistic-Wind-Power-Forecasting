...
% In this function, we optimize (theta,alpha,delta), all together.
% In the end, we have some initial and final points.
...
%     Theta_0   Alpha     Delta     Product     Eval (*1.0e+04)
%     =========================================================
%     2.2210    0.0436    0.0856    0.0969     -3.6964
%     1.4617    0.0664    0.0844    0.0971     -3.6963
%     1.3647    0.0712    0.0839    0.0971     -3.6962
%     1.4607    0.0665    0.0844    0.0971     -3.6963
%     1.4422    0.0673    0.0842    0.0971     -3.6963
%     1.4653    0.0663    0.0842    0.0971     -3.6963
%     1.4585    0.0665    0.0843    0.0970     -3.6963
%     1.2390    0.0784    0.0837    0.0972     -3.6962
%     2.6163    0.0370    0.0901    0.0968     -3.6963
%     2.7354    0.0353    0.0877    0.0964     -3.6962
%     2.7330    0.0354    0.0910    0.0967     -3.6962
%     2.7365    0.0354    0.0922    0.0968     -3.6962
%     2.7901    0.0347    0.0913    0.0967     -3.6961
%     2.7938    0.0350    0.0923    0.0977     -3.6961
%     2.7364    0.0354    0.0909    0.0968     -3.6962
%     2.3509    0.0412    0.0883    0.0968     -3.6964
%     2.3509    0.0412    0.0880    0.0969     -3.6964
%     2.0711    0.0466    0.7088    0.0965     -3.6955
%     2.3536    0.0411    0.0882    0.0968     -3.6964
%     2.4210    0.0400    0.0888    0.0969     -3.6963
%     2.3508    0.0412    0.0894    0.0968     -3.6964
