...
%%                                          %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Supplementary Material (2/3): Used Data}
...
\begin{abstract}
In this material, we provide the data used during the fitting. We can find the real production and the forecast for each provider. We also show other fundamental functions used in the fitting ad the forecast error, the forecast error transitions, and the forecast derivative.
\end{abstract}
...
\section{Provider A}
\quad
\graphicspath{{./plots/data_plots/prov_A/}}

\newcounter{i}
\newcounter{j}

\forloop{i}{0}{\value{i} < 73}{

\setcounter{j}{\value{i}*2+1}

\begin{figure}[!htb]
\centering
{\includegraphics[width=\mysize\columnwidth]{plots/\arabic{j}.eps}}\quad
{\includegraphics[width=\mysize\columnwidth]{error/\arabic{j}.eps}}\\
\quad\\
{\includegraphics[width=\mysize\columnwidth]{transition/\arabic{j}.eps}}\quad
{\includegraphics[width=\mysize\columnwidth]{derivative/\arabic{j}.eps}}\\
\quad\\
\setcounter{j}{\value{i}*2+2}
{\includegraphics[width=\mysize\columnwidth]{plots/\arabic{j}.eps}}\quad
{\includegraphics[width=\mysize\columnwidth]{error/\arabic{j}.eps}}\\
\quad\\
{\includegraphics[width=\mysize\columnwidth]{transition/\arabic{j}.eps}}\quad
...
\section{Provider B}
\quad
\graphicspath{{./plots/data_plots/prov_B/}}
...
\section{Provider C}
\quad
\graphicspath{{./plots/data_plots/prov_C/}}
