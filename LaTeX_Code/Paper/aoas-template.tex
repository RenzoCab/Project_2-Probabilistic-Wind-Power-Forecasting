...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.485\textwidth]{plots/classic_noDelta/Optimal.eps}
\includegraphics[width=0.485\textwidth]{plots/classic_noDelta/Lamperti_Optimal.eps}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{plots/delta/contour_delta.eps}
