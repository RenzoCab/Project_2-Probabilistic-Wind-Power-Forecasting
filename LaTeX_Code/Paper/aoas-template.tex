...
\begin{figure}[H]
\centering
  \includegraphics[width=0.485\textwidth]{plots/31_2.eps}\quad\includegraphics[width=0.485\textwidth]{plots/31.eps}
...
This work was partially supported by the KAUST Office of Sponsored Research (OSR) under Award number URF/1/2584 -- 01 -- 01 in the KAUST Competitive Research Grants Program Round 8 and the Alexander von Humboldt Foundation.
