...
Keywords: Wind power, probabilistic forecasting, stochastic differential equations, Lamperti transform, numerical optimizaton, model selection.

2020 AMS Subject Classification: 60H10, 62M20.
...
In this work, we propose a method to assess the short-term forecast of the normalized wind power, which is agnostic of the wind power forecast technology. 
