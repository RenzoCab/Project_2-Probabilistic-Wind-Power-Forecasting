...
{\color{red} 2020 AMS Subject Classification: 60H10, 62M20}
...
We can see in Figure (\ref{fig:LP_transitions}) how the Lamperti transform modifies the forecast error transition histogram without curtailment displayed in Figure (\ref{fig:error_transitions}). 
