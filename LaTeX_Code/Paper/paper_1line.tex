...
{\color{red} Description of the global 2019 dataset, then the dataset after removing the days with curtailment (curtailment detection and removal), analysis of the dataset without curtailment.}
