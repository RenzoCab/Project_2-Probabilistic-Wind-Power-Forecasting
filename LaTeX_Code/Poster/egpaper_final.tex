...
4700 KAUST, Thuwal-Jeddah, Saudi Arabia\\
...
\begin{equation}
\begin{split}
dV_t &= -\theta V_t dt + \sqrt{2 \theta \alpha p_t(1-p_t) (V_t +p_t ) (1-V_t-p_t)} dW_t\\
V_0 & = v_0
...
where $\theta >0 $ and $\alpha>0$ are parameters to be inferred. 
